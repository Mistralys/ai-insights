# MCP Server - Manifest (UI Components)
<INSTRUCTION>
# MCP Server - Manifest: UI Components
CSS component library for the GUI: custom properties (light/dark theme tokens), badge and banner colour tokens, layout classes, button classes, and all view-specific component classes. Use this reference when adding new UI elements — reuse existing classes before creating new ones.

</INSTRUCTION>
------------------------------------------------------------
_SOURCE: GUI-layer CSS component catalogue (tokens, badges, banners, layout, buttons, view components)_
# GUI-layer CSS component catalogue (tokens, badges, banners, layout, buttons, view components)
```
...
```
###  Path: `/mcp-server/gui/docs/agents/project-manifest/ui-components.md`
