...
<INSTRUCTION>
# MCP Server - Manifest: Data Flows
Tool invocation lifecycle, storage paths, inter-module data movement, ledger read/write patterns, and GUI polling/DOM-patching flows.
...
# GUI-layer data flows (server startup, request lifecycle, polling, DOM patching, orchestrator queue, run log streaming)
```
// Structure of documents
└── mcp-server/
    └── gui/
...
```
###  Path: `/mcp-server/gui/docs/agents/project-manifest/data-flows.md`
