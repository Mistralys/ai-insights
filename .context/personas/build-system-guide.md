# Personas - Build System Guide
<INSTRUCTION>
# Personas - Build System Guide
Detailed reference for the persona build system: build pipeline, template syntax, metadata schema, partials, versioning, subagent declarations, name-mapping generation, and model resolution (loadModelRegistry / resolveModel priority chain).
</INSTRUCTION>
------------------------------------------------------------
_SOURCE: Build system guide (pipeline, template syntax, metadata schema, name-mapping, model resolution)_
# Build system guide (pipeline, template syntax, metadata schema, name-mapping, model resolution)
```
...
```
###  Path: `/personas/docs/persona-build-system.md`
