...
```
###  Path: `/scripts/lib/claude-cli.js`
...
```
###  Path: `/scripts/lib/frontmatter.js`
...
```
###  Path: `/scripts/lib/launch-agent-core.js`
...
```
###  Path: `/scripts/lib/original-cwd.js`
