...
| 4 | Communications Curator | v1.1.0 | 2026-08-26 | v3.2 | v3.2 | B (1p/0c) | PASS (v3.2) |  |
| 5 | Dependency Curator | v1.2.1 | 2026-08-26 | v3.2 | v3.2 | B (3p/0c) | PASS (v3.2) |  |
| 6 | Documentation (Standalone) | v1.1.1 | 2026-08-26 | v3.2 | v3.2 | B (3p/1c) | PASS (v3.2) |  |
| 7 | Module Intent Architect | v1.1.1 | 2026-08-26 | v3.2 | v3.3 | A | PASS (v3.3) |  |
| 8 | Plan Architect Reviewer | v2.3.1 | 2026-08-26 | v3.2 | v3.2 | B (1p/1c) | PASS (v3.2) |  |
| 9 | Plan Auditor | v1.9.1 | 2026-08-26 | v3.2 | v3.2 | B (1p/0c) | PASS (v3.2) |  |
| 10 | Plan Refiner | v1.6.1 | 2026-08-26 | v3.2 | v3.2 | B (0p/7c) | PASS (v3.2) |  |
| 11 | README Curator | v1.5.1 | 2026-08-26 | v3.2 | v3.2 | B (1p/0c) | PASS (v3.2) |  |
| 12 | Recipe Curator | v1.11.1 | 2026-08-26 | v3.2 | v3.3 | A | PASS (v3.3) |  |
| 13 | Researcher | v1.3.1 | 2026-08-26 | v3.2 | v3.3 | A | PASS (v3.3) |  |
| 14 | Unit Test Auditor | v1.2.1 | 2026-08-26 | v3.2 | v3.2 | B (1p/0c) | PASS (v3.2) |  |
| 15 | Usage Scenarios Curator | v1.2.1 | 2026-08-26 | v3.2 | — | A | — | Tone fix only |
| 16 | Web GUI Specialist | v1.4.0 | 2026-08-26 | v3.2 | v3.2 | B (3p/1c) | PASS (v3.2) |  |
| 17 | WHATSNEW Curator | v1.1.1 | 2026-08-26 | v3.2 | v3.3 | A | PASS (v3.3) |  |
| 18 | CTX Architect | v1.3.3 | 2026-08-27 | v3.4 | v3.3 | A | PASS (v3.3) | Principle renamed to canonical "Every Artefact Earns Its Place" (C5c) |
| 19 | Developer (Standalone) | v1.13.0 | 2026-08-27 | v3.4 | v3.3 | B (9p/1c) | PASS (v3.3) | Paired audit with ledger twin — 11 findings, all resolved |
| 20 | Persona Curator | v1.15.0 | 2026-08-27 | v3.4 | v3.4 | A | PASS | Full self-audit at v3.2, rolled forward |
...
| 3 | Ledger Standalone Archiver | v1.7.0 | 2026-08-21 | v2.5 | — | B (1p/0c) | — | First audit — 16 findings, all resolved; Inputs described a three-way choice the subagent dispatch never offers, and Outputs omitted the file it writes |
| 4 | Ledger Doctor | v1.3.1 | 2026-08-26 | v3.2 | — | A | — | Tone fix only |
| 5 | Ledger Orchestrator Archaeologist | v1.0.2 | 2026-08-26 | v3.2 | — | A | — | Tone fix only |
| 6 | Ledger Bootstrapper | v1.4.0 | 2026-08-28 | v3.4 | v3.4 | B (2p/0c) | PASS | First audit — 10 findings, all resolved; two required parameters had no documented source |
| 7 | Ledger Dependency Sequencer | v1.4.4 | 2026-08-28 | v3.4 | v3.4 | B (1p/0c) | PASS | First audit — 9 findings, all resolved; density delta pass applied at v3.4 |
| 8 | Ledger Knowledge Archiver | v1.9.0 | 2026-08-28 | v3.4 | v3.4 | A | PASS | First audit — 14 findings, all resolved; Mode A read a sidecar the ledger agents stopped writing, and two commit parameters had no Mode A source |
| 9 | Ledger Knowledge Curator | v1.4.0 | 2026-08-28 | v3.4 | v3.4 | A | PASS | First audit — 15 findings, all resolved; MERGE had no legal deletion path and RESCOPE contradicted the no-creation rule |
