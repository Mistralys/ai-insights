...
1. **Original Work Package:** Retrieved via `ledger_get_work_package` — the source of truth for requirements and AC (title, description, acceptance_criteria, and implementation artifacts).
