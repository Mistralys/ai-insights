...
| `manifest-curator` | Manifest Curator | Create and update project manifests — the source of truth for AI agent sessions. Auditing belongs to the Manifest Reviewer. | `manifest-curator.agent.md` | `manifest-curator.md` |
| `manifest-reviewer` | Manifest Reviewer | Falsify the claims a project manifest makes — claim-first verification across the manifest and the documents restating its facts, producing an evidence-bearing Discrepancy Report. | `manifest-reviewer.agent.md` | `manifest-reviewer.md` |
